...
public class EchoClient {
    ...
    public static void main(String[] args) {
            ...
            try (
                    Socket clientSocket = new Socket(InetAddress.getByName(args[0]), portNumber); //InetAddreess.getByName() usado quando trabalha-se com IP
                ...
                } while (!toServer.equals("Adeus")); //Quando o utilizar escrever Adeus, o programa é finalizado
