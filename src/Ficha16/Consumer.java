...
public class Consumer implements Runnable{
    ...
    private int retirarItem() {
        for (int i = 0; i < Buffer.bufferSize; i++) {
            ...
            if (Buffer.isOccupied[i] == true) {
                ...
                System.out.println("A thread " + Thread.currentThread().getName() + " retirou o item " + item + " na posição " + i + " do buffer");
    ...
    @Override
    public void run() {
        Thread.currentThread().setName("Consumidora " + Thread.currentThread().getId());
